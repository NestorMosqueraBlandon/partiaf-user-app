...
import { IStore } from "../../screens/Stores";
    ...
    return (
       <View style={{marginBottom: 20}}>
            <View style={styles.header}>
                <View>
                    <Text style={{fontWeight: '900', fontSize: 18}}>{name} - <Text style={{fontWeight: '500', color: 'rgba(0,0,0, 0.5)', fontSize: 14}}>{type}</Text></Text>
                    <Text style={{fontWeight: '500', color: 'rgba(0,0,0,.3)'}}>Santa Marta, Colombia</Text>
                </View>
            ...
            <Image source={{uri: photos[0]}} style={{marginTop: 10, width: "100%", resizeMode: 'cover', height: 500}} />
            </View>

            <View style={{display: 'flex', marginTop: 8, marginLeft: 20, marginRight: 20, alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between'}}>
